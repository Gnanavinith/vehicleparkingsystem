...
const css = `
  ...
  :root {
    ...
    --tb-subtle:    #94a3b8;
    --tb-accent:    #0f766e;
    --tb-accent-bg: rgba(15,118,110,0.07);
    --tb-accent-bd: rgba(15,118,110,0.18);
    --tb-hover:     #f1f5f9;
    --tb-danger:    #ef4444;
    --tb-danger-bg: #fef2f2;
    --tb-success:   #10b981;
  ...
  .tb-clear-btn:hover { color: #0d9488; }
  ...
  .tb-view-all:hover { color: #0d9488; }
            ...
            {showProfile && (
              <div className="tb-dropdown tb-profile-dropdown">
                <div className="tb-profile-info">
                  ...
                  <div className="tb-profile-info-email">{user?.email || 'admin@stand.com'}</div>
                  <span className="tb-role-chip">
                    <NavIcon icon={FaBuilding} size={8} />
                    {roleLabel}
                  </span>
                </div>
