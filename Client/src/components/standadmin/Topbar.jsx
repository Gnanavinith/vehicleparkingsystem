...
import { FaSearch, FaChevronDown, FaBell, FaUser, FaBuilding, FaKey, FaCog, FaSignOutAlt } from 'react-icons/fa';
...
const css = `
  ...
  *, *::before, *::after { box-sizing:border-box; }
  ...
  .tb-clear-btn {
    ...
    font-family:'DM Mono',monospace; letter-spacing:.04em; text-transform:uppercase; transition:color .13s;
  }
  ...
  .tb-view-all {
    ...
    background:none; border:none; cursor:pointer;
    font-family:'DM Mono',monospace; letter-spacing:.06em; text-transform:uppercase; transition:color .13s;
  }
  ...
  .tb-profile-info-name {
    font-family:'DM Serif Display',serif; font-style:italic;
    font-size:15px; color:#0a0a0a; line-height:1.2;
  }
...
const NOTIFS = [
  { id:1, message:'New staff member added to your stand', time:'1h ago',  type:'info' },
  { id:2, message:'Daily revenue target achieved',        time:'4h ago',  type:'success' },
  { id:3, message:'Parking space maintenance required',   time:'1d ago',  type:'warning' },
];

const ROLE_LABELS = { super_admin:'Super Admin', stand_admin:'Stand Admin', staff:'Staff' };

export default function StandAdminTopbar() {
  ...
  const roleLabel = ROLE_LABELS[user?.role] || 'Stand Admin';
    ...
    <>
      ...
      <header className="tb-root">
        ...
        <div className="tb-search">
          <input className="tb-search-input" placeholder="Search staff, parkings…" />
        ...
        <div className="tb-right">
          ...
          <div style={{ position:'relative' }} ref={profileRef}>
            ...
            >
              ...
              <span className="tb-profile-name">{user?.name || 'Stand Admin'}</span>
            ...
            {showProfile && (
              <div className="tb-dropdown tb-profile-dd">
                <div className="tb-profile-info">
                  <div className="tb-profile-info-name">{user?.name || 'Stand Admin'}</div>
                  <div className="tb-profile-info-email">{user?.email || 'admin@parkingpro'}</div>
                  <span className="tb-role-chip"><FaBuilding size={7} /> {roleLabel}</span>
                </div>
